...
Building scalable backend systems, AI-powered applications, and real-time web platforms.
...
AI-Powered CSV Import Platform
...
`Next.js` `Node.js` `Express` `Gemini API` `PapaParse`
...
Full Stack SaaS Sponsorship Platform
...
<p>
<a href="https://aroviavibes.vercel.app"><img src="https://img.shields.io/badge/Live-Demo-success?style=flat-square"/></a>
<a href="https://github.com/guptakaran20/AroviaVibes"><img src="https://img.shields.io/badge/GitHub-Repository-black?style=flat-square&logo=github"/></a>
</p>
